package com.w3engineers.mesh.datasharing.helper;
...
public class PreferencesHelper{
    ...
    public static final int MESH_STOP = 4;
...
//    public int getGiftEndpointType() {
//        return SharedPref.readInt(GIFT_ENDPOINT_TYPE, PayLibConstant.END_POINT_TYPE.ETC_KOTTI);
//    }
//
//    public void setGiftEndpointType(int endpointType) {
//        SharedPref.write(GIFT_ENDPOINT_TYPE, endpointType);
//    }
    ...
    /*public void setEndPointMode(String mode) {
        SharedPref.write(CURRENCY_MODE, mode);
    }

    public String getEndpointMode() {
        return SharedPref.read(CURRENCY_MODE, "ETC");
    }*/
}
