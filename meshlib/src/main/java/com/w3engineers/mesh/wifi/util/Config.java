...
/**
 * Bonjour configuration related staff manager
 */
public class Config {
    ...
    public static final int bnjHeartbeatInterval = 3 * 1000;

    public static final int bnjTimeoutInterval = 60 * 1000;

    public static final int bleHeartbeatInterval = 3 * 1000;
