...
public class UserModel implements Serializable, Comparable<UserModel> {
    ...
    public boolean mIsLocallyAlive;
...
*/
    ...
    public String toString() {
        return "UserModel{" +
                ...
                ", userName='" + userName + '\'' +
                ", userId='" + userId + '\'' +
                ", mIsLocallyAlive=" + mIsLocallyAlive +
                ", isSent=" + isSent +
                '}';
    }

    public static UserModel fromJSON(String userInfo) {
        try {
    ...
    public static String getUserJson() {
        ...
        try {
            //jsonObject.put(JsonKeys.KEY_USER_ID, SharedPref.read(Constant.KEY_USER_ID));
